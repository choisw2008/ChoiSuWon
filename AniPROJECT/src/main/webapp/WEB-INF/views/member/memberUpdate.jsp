		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="Email" name="Email"
					value="${member.email}" maxlength="16" placeholder="Email을 입력하세요"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="pnum" name="pnum"
					value="${member.pnum}" maxlength="16" placeholder="전화번호을 입력하세요"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="address" name="address"
					value="${member.address}" maxlength="16" placeholder="주소을 입력하세요"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" class="form-control" id="gender" name="gender"
					value="${member.gender}" maxlength="16" placeholder="성별을 입력하세요"/>
			</div>
		</div>
		<div class="form-group">
